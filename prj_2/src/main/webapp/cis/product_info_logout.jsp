...
<body>
	<div class="wrap">
		...
		<div class="header">
          ...
          <a href="http://localhost/html_prj/project/join.jsp"  class="a_join_member"">회원가입</a>
       </div>

       <div class="login">
         <a href="http://localhost/html_prj/project/login.jsp" class="a_login" >로그인</a>
       </div>
       </div>

    	<!--   <div class="logout">
         	<a href="http://localhost/html_prj/project/main_logout.jsp" class="a_login" >로그아웃</a>
       		</div> -->
...
<div class="product_info">
	...
	<div class="prod-info">
		...
		<dl class="prod-info-row">
			...
			<dd class="prod-info-dd">역삼동</dd>
		</dl>
		<hr class="prod-info-line">
		<dl class="prod-info-row">
			<dt class="prod-info-dt">관심</dt>
			<dd class="prod-info-dd">50</dd>
		</dl>
		<dl class="prod-info-row">
			<dt class="prod-info-dt">문의글</dt> 
			<dd class="prod-info-dd">15</dd>
		</dl>
		<dl class="prod-info-row">
			<dt class="prod-info-dt">조회수</dt>
			<dd class="prod-info-dd">65</dd>
		</dl>
		<hr class="prod-info-line">
	</div>
	<br/>
...
<input type="button"id="move-mainpage-button"value="상품 더보기 >"onclick="location.href='http://localhost/prj_2/lmh/main_logout.jsp'"/>
</div>
<div class="card-photo1"onclick="location.href='http://localhost/prj_2/cis/product_info_logout.jsp'">
...
<div class="card-photo2"onclick="location.href='http://localhost/prj_2/cis/product_info_logout.jsp'">
     <img alt="매물" src="" class="photo">
</div>
...
<div class="card-photo3"onclick="location.href='http://localhost/prj_2/cis/product_info_logout.jsp'">
     <img alt="매물" src="" class="photo">
</div>
...
<div class="card-photo4"onclick="location.href='http://localhost/prj_2/cis/product_info_logout.jsp'">
     <img alt="매물" src="" class="photo">
</div>
 ...
 <div class="card-photo5"onclick="location.href='http://localhost/prj_2/cis/product_info_logout.jsp'">
     <img alt="매물" src="" class="photo">
</div>
