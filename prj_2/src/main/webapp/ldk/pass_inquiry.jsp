...
function nullCheck() {
	...
	location.href="http://localhost/prj_2/ldk/succ_pass_inquiry.jsp";
}
</script>
</head>
<body>
...
<div id="container">
	...
	<div id="div3">
		...
		<input type="text" id="inputBox1" name="id" placeholder="아이디">
	</div>
	<div id="div4">
		<label id="font1">이메일&nbsp</label>
		<input type="text" id="inputBox2" name="email" placeholder="이메일"> @ 
