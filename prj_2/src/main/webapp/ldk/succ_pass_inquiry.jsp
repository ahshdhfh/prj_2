...
#colorBtn2{position: absolute; left: 600px; top: 470px; width:180px;height: 50px;font-size:20px;
		border: 1px solid #333;cursor: pointer;background-color: #9A58B5;color:#FFF;font-weight: bold;border-radius: 10px;}
#whiteBtn2{position: absolute; left: 420px; top: 470px; width:180px;border-radius: 10px;font-size:20px;
		height: 50px;border: 1px solid #333;cursor: pointer;background-color: #fff;color:#333;font-weight: bold}
...
<div id="header">
	...
	<input type="button" id="colorBtn" value="비밀번호찾기" onclick="linkPassInq()">
	</a>
	<a href="http://211.63.89.142/html_prj/project/id_inquiry.jsp">
	<input type="button" id="whiteBtn" value="아이디찾기" onclick="linkIdInq()">
	</a>
	<a href="http://localhost/prj_2/lmh/main_logout.jsp">
	<img id="logo" alt="logo"  src="http://localhost/prj_2/images/logo.png">
	</a>
</div>
...
<div id="container">
	<div id="div1">
		<font id="font3">비밀번호 찾기 성공!</font>
	</div>
	<div id="div2" >
		회원님의 임시설정 비밀번호<br><br>
		<input type="text" id="inputBox1" value="qwer1234" readonly="readonly"><br><br>
		로그인 후<br><br>'마이페이지-개인정보변경' 에서<br><br>
		비밀번호 변경이 가능합니다.	
	...
	<a href="http://localhost/prj_2//main_logout.jsp">
	<input type="button" id="colorBtn2" value="마이페이지">
	</a>
</div><!-- container -->
</form>
